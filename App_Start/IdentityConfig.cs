        ...
        void SendMail(IdentityMessage message)
        {
            ...
            switch (message.Subject)
            {
                case "Reset Password":
                    ...
                    text = string.Format(message.Body);
                    html = string.Format(message.Body);
            ...
            //msg.Headers.Add("Sender", "stdcontact@cste.org");
            msg.From = new MailAddress("stdcontact@cste.org", "STD Contact Board");
